...
describe('TixelMatrix buffer', function () {
    it('should add data to the buffer', function () {
        ...
        var position = [2,2];
        var buffer = [1,1];
        t.setBuffer(position[0], position[1], buffer);
    ...
    it('should write buffer to matrix', function () {
        ...
        var position1 = [0,0];
        var buffer1 = [1,0];
        t.setBuffer(position1[0], position1[1], buffer1);
        var position2 = [1,0];
        var buffer2 = [1];
        t.setBuffer(position2[0], position2[1], buffer2);
        var position3 = [2,0];
        var buffer3 = [];
        t.setBuffer(position3[0], position3[1], buffer3);
        t.applyBuffer();
